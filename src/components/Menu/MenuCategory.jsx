...
const MenuCategory = ({ selectedCuisine, onCuisineSelect }) => {
 ...
 const cuisines = ['All', 'Italian', 'Indian', 'American', 'French', 'Greek', 'Spanish', 'Mexican'];
 ...
 return (
   <div className="flex flex-wrap justify-center gap-2 sm:gap-4 md:gap-6">
     {cuisines.map((type) => (
       <p
         key={type}
         className={`p-2 sm:p-3 md:p-4 cursor-pointer rounded-lg transition-colors duration-200 ${
