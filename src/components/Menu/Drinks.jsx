        ...
        <SwiperSlide>
          <div className="border-2 border-solid border-gray-400 bg-white max-w-[480px] lg:max-w-[100%] lg:max-h-[100%] md:max-w-[500px] flex gap-3 items-center justify-start mb-12">
            ...
            <div className="flex-1">
              <h3 className="text-xl text-black pb-1 lg:text-2xl md:text-xl">{drink.title}</h3>
              <div className="price text-xl text-[#cd9452] mb-1 lg:text-2xl md:text-xl">${drink.price}</div>
              <button
