  ...
  return (
    <section
      ...
      >
        ...
        <div className="px-[3rem] py-[4rem] lg:p-[9.6rem_3.2rem] md:p-[4.5rem_3rem] sm:p-[4.5rem_3rem]">
        <span className="sub-heading text-xl font-bold uppercase text-center block mb-4">
          TESTIMONIALS
        </span>
        <h2 className="text-4xl main-heading font-bold text-center mb-8">
          Taste it once, crave it forever.
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 forum">
          ...
          <figure className="text-center">
            ...
            <p className="text-base font-bold">&mdash; Dave Bryson</p>
          </figure>
        </div>
      </div>
      </section>
