...
const FoodItem = ({ image, title, description, price , type}) => {
    ...
    return (
        <div className="bg-white border border-gray-100 transition transform duration-700 hover:shadow-xl hover:scale-105 p-4 rounded-lg relative">
            ...
            <span className="bg-red-100 border border-red-500 rounded-full text-primary text-sm poppins px-4 py-1 absolute top-4 right-4 inline-block">{cuisinetype}</span>
